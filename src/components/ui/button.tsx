...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-mountain hover:shadow-lg",
        destructive:
        ...
        alpine: "hero-gradient text-white font-semibold shadow-mountain hover:scale-105 transition-spring",
        glass: "glass-effect text-white hover:bg-white/20 shadow-glass",
        golden: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-elevation font-semibold",
      },
      size: {
